                ...
                <div className="w-full">
                    ...
                    <div className="w-full flex justify-between mt-4">
                        <div className="rounded-3xl overflow-hidden flex justify-center items-center">
                           ...
                           {!img && <img className="h-24 w-24" src='https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png'/>}                        
                        </div>
                        <div className="flex items-center flex-col">
                            <p><strong className="text-blue-500">Your email:</strong><span>{currentUser.email}</span></p>
