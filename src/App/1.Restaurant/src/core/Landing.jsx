...
export function Landing() {
    return (
        <>
           <ParallaxProvider>
                <ParallaxBanner layers={[{image: require(`../../css/images/others/girl.jpg`), opacity: [1,0.5]},
                    {children:<LandingComponent1></LandingComponent1>, opacity: [1,0.9]}]} 
                    style={{height: '850px', marginTop: '80px'}}/>
                
                <LandingComponent2/>
                
                <ParallaxBanner layers={[{image: require(`../../css/images/others/seating.jpg`), speed: -50, opacity: [1,.5]},
                ...
                <ParallaxBanner layers={[{image: require(`../../css/images/others/chef.jpg`), speed: -80, opacity:[.8,1]},
