...
export function LandingComponent6() {
  ...
  return (
    <>
      <section className='min-w-full h-auto bg-gradient-to-b from-slate-300 to-slate-600 flex px-4 sm:px-14 pb-8'>
    ...
    <h1 className='text-center bg-slate-600 text-white'>&copy; LiFoodie 2022 - all rights reserved</h1>   
    </>
  )
}
