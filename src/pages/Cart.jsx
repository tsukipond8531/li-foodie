...
export const Cart = () => {
    ...
    let grandTotal = 0
    for(let i = 0; i <= item_name.length; i = i+1)
    {
    ...
    return(
        <section className='w-full h-auto flex justify-center sm:px-4 px-2'>
            <div className='mt-32 flex-1 h-full max-w-xl mx-auto shadow-2xl bg-white bg-opacity-10 sm:bg-opacity-50 shadow-zinc-900 rounded-2xl overflow-hidden py-2 border border-t-0 border-l-0 border-white border-opacity-30'>
