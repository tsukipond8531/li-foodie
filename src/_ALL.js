...
import {About, Activity, Branches, Contact, ForgotPassword, Login, Navbar, Cart, Profile, Restaurant, Signup, Payment, Checkout, Landing ,Error404, UpdateProfile, SubMenu} from './core/_CORE'
